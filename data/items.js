export default {
    '1 Hour Booster': {
        image: '/content/items/1 Hour Booster.png',
    ...
    '3 Hour Booster': {
        image: '/content/items/3 Hour Booster.png',
    ...
    'Stealth Disguise Kit (Item)': {
        image: '/content/items/Stealth Disguise Kit.png',
    ...
    'Fragment Grenade (Item)': {
        image: '/content/items/Fragment Grenade.png',
    ...
    'Clan Shield': {
        image: '/content/items/Clan Shield.png',
    ...
    'Red Paint Bucket': {
        image: '/content/items/Red Paint Bucket.png',
    ...
    'Orange Paint Bucket': {
        image: '/content/items/Orange Paint Bucket.png',
    ...
    'Yellow Paint Bucket': {
        image: '/content/items/Yellow Paint Bucket.png',
    ...
    'Green Paint Bucket': {
        image: '/content/items/Green Paint Bucket.png',
    ...
    'Lime Paint Bucket': {
        image: '/content/items/Lime Paint Bucket.png',
    ...
    'Cyan Paint Bucket': {
        image: '/content/items/Cyan Paint Bucket.png',
    ...
    'Blue Paint Bucket': {
        image: '/content/items/Blue Paint Bucket.png',
    ...
    'Purple Paint Bucket': {
        image: '/content/items/Purple Paint Bucket.png',
    ...
    'Magenta Paint Bucket': {
        image: '/content/items/Magenta Paint Bucket.png',
    ...
    'Pink Paint Bucket': {
        image: '/content/items/Pink Paint Bucket.png',
    ...
    'Brown Paint Bucket': {
        image: '/content/items/Brown Paint Bucket.png',
    ...
    'Black Paint Bucket': {
        image: '/content/items/Black Paint Bucket.png',
    ...
    'Rainbow Paint Bucket': {
        image: '/content/items/Rainbow Paint Bucket.png',
